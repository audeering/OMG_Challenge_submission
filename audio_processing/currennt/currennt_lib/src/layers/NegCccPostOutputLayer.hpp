...
#ifndef LAYERS_NEGCCCPOSTOUTPUTLAYER_HPP
#define LAYERS_NEGCCCPOSTOUTPUTLAYER_HPP
...
namespace layers {
    ...
    class NegCccPostOutputLayer : public PostOutputLayer<TDevice>
    {
    public:
        /**
    ...
    private:
        typename TDevice::real_vector _Q;
        typename TDevice::real_vector _S;
        typename TDevice::real_vector _target_means;
    };

} // namespace layers


#endif // LAYERS_NEGCCCPOSTOUTPUTLAYER_HPP
